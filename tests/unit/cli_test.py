...
class CliLoginSpec(CliSpec):
    def test_login_succeeded(self):
        ...
        # Act
        with patch('khulnasoft_analyze_cli.commands.login'):
    ...
    def test_login_succeeded_with_url(self):
        ...
        # Act
        with patch('khulnasoft_analyze_cli.commands.login') as mock:
    ...
    def test_login_invalid_key(self):
        ...
        # Act
        with patch('khulnasoft_analyze_cli.cli.api.set_global_api',
    ...
    def test_analyze_exits_when_not_login(self):
        ...
        with patch('khulnasoft_analyze_cli.cli.key_store.get_stored_key', return_value=None):
            # Act
...
class CliAnalyzeSpec(CliSpec):
    def setUp(self):
        ...
        create_global_api_patcher = patch('khulnasoft_analyze_cli.commands.login')
        ...
        create_analyze_file_command_patcher = patch('khulnasoft_analyze_cli.commands.analyze_file_command')
    ...
    @patch('khulnasoft_analyze_cli.commands.analyze_directory_command')
...
class UploadOfflineEndpointScanSpec(CliSpec):
    def setUp(self):
        ...
        create_global_api_patcher = patch('khulnasoft_analyze_cli.cli.create_global_api')
        self.create_global_api_patcher_mock = create_global_api_patcher.start()
        self.addCleanup(create_global_api_patcher.stop)

        key_store.get_stored_api_key = MagicMock(return_value='api_key')

    @patch('khulnasoft_analyze_cli.commands.upload_offline_endpoint_scan')
    ...
    @patch('khulnasoft_analyze_cli.commands.upload_multiple_offline_endpoint_scans')
...
class UploadPhishingSpec(CliSpec):
    @patch('khulnasoft_analyze_cli.commands.send_phishing_emails_from_directory_command')
...
class CliIndexSpec(CliSpec):
    ...
    @patch('khulnasoft_analyze_cli.commands.index_file_command')
    ...
    @patch('khulnasoft_analyze_cli.commands.index_directory_command')
    ...
    @patch('khulnasoft_analyze_cli.commands.index_by_txt_file_command')
