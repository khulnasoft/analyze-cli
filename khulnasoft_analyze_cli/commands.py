...
from khulnasoft_analyze_cli.utilities import is_hidden
...
def login(api_key: str, api_url: str):
    try:
        ...
        click.echo(f'Invalid API key error, please contact us at support@khulnasoft.com '
...
def analyze_file_command(file_path: str,
    ...
    except sdk_errors.KhulnasoftError as e:
            ...
            for file_name in files:
                ...
                if disable_dynamic_unpacking and not utilities.is_supported_file(file_path):
                    ...
                    try:
                        ...
                        success_number += 1
                    except sdk_errors.KhulnasoftError as ex:
    ...
    try:
        ...
        with click.progressbar(length=len(hashes),
            ...
            for file_hash in hashes:
                ...
                except sdk_errors.KhulnasoftError:
